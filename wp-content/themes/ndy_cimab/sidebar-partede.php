<?php $ongs = new WP_Query( array( 'post_type' => 'ongs', 'posts_per_page' => 6, 'orderby' => 'rand' ) ); ?>
			...
			<?php while( $ongs->have_posts() ) : $ongs->the_post(); ?>
				<li>
					<a href="<?php echo the_field( 'url_ong' ); ?>" target="_blank">
						<?php $ong_logo = get_field( 'ong_logo' ); ?>
						<img src="<?php echo $ong_logo['url']; ?>" alt="<?php the_title(); ?>">
					</a>
				</li>
			<?php endwhile; ?>
		</ul>
